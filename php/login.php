...
<main>
    <form class="sign">
        ...
        <div>
            <p class="label-txt"><label for="username-email">ENTER YOUR USERNAME / EMAIL</label></p>
            <input type="text" class="input" name="username-email" id="username-email" autocomplete="off" required/>
            <div class="line-box">
                <div class="line"></div>
            </div>
        </div>
